...
const Section01 = () => {
    ...
    return (
        ...
        <>
            <div id="header_sticky" className="lg:sticky lg:inset-x-0 lg:top-0 lg:z-[90] flex max-lg:items-center max-lg:h-[66px]  lg:bg-opacity-95 lg:backdrop-blur px-[var(--size-20)] lg:px-0 top-header">
                ...
                <div className="transition-colors duration-300 max-lg:hidden cursor-pointer absolute right-0 inset-y-0 flex items-center justify-center">
                    <div className="border-l border-current absolute left-0 top-0 h-full lang-vertical-line"></div>
                    <a href="https://atolldigital.com/fr/" className="lang-switcher text-[1vw] font-medium px-[1vw] flex items-center justify-center h-full w-full overflow-hidden leading-none">
