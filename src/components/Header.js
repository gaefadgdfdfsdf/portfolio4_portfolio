  ...
  return (
    <>
         <div id="header_sticky"
             ...
             className={`max-lg:hidden lg:sticky lg:inset-x-0 lg:z-[90] flex max-lg:items-center max-lg:h-[66px] bg-[#E6E8EA] lg:bg-opacity-95 lg:backdrop-blur px-[var(--size-20)] lg:px-0 top-header ${showHeader ? 'block' : 'hidden'}`}>
