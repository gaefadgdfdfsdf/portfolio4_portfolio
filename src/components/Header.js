        ...
        <>
            <div id="header_sticky"
                ...
                <div className="transition-colors duration-300 left-logo-header lg:border-r lg:border-current w-[86px] lg:w-[7.083333333333333vw]">
                    <a href="https://joyunhahahaha.github.io/portfolio4_portfolio/" className="w-full lg:h-full flex items-center justify-center">
                ...
                <div className="host-grotesk-bold transition-colors duration-300 max-lg:hidden cursor-pointer absolute right-0 inset-y-0 flex items-center justify-center">
                    ...
                    <a href="https://github.com/joyunhahahaha?tab=repositories" target='_blank' className="h-[3.472vw] text-[1vw] font-medium px-[1vw] flex items-center justify-center w-full overflow-hidden leading-none">
